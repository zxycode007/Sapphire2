...
namespace std
{
	...
	template <class T> typename Sapphire::List<T>::ConstIterator begin(const Sapphire::List<T>& v) { return v.Begin(); }

	template <class T> typename Sapphire::List<T>::ConstIterator end(const Sapphire::List<T>& v) { return v.End(); }

	template <class T> typename Sapphire::List<T>::Iterator begin(Sapphire::List<T>& v) { return v.Begin(); }

	template <class T> typename Sapphire::List<T>::Iterator end(Sapphire::List<T>& v) { return v.End(); }
