...
namespace std
{
	...
	template <class T> typename Sapphire::HashSet<T>::ConstIterator begin(const Sapphire::HashSet<T>& v) { return v.Begin(); }

	template <class T> typename Sapphire::HashSet<T>::ConstIterator end(const Sapphire::HashSet<T>& v) { return v.End(); }

	template <class T> typename Sapphire::HashSet<T>::Iterator begin(Sapphire::HashSet<T>& v) { return v.Begin(); }

	template <class T> typename Sapphire::HashSet<T>::Iterator end(Sapphire::HashSet<T>& v) { return v.End(); }
