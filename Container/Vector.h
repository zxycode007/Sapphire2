...
namespace std
{
	...
	template <class T> typename Sapphire::Vector<T>::ConstIterator begin(const Sapphire::Vector<T>& v) { return v.Begin(); }

	template <class T> typename Sapphire::Vector<T>::ConstIterator end(const Sapphire::Vector<T>& v) { return v.End(); }

	template <class T> typename Sapphire::Vector<T>::Iterator begin(Sapphire::Vector<T>& v) { return v.Begin(); }

	template <class T> typename Sapphire::Vector<T>::Iterator end(Sapphire::Vector<T>& v) { return v.End(); }

	template <class T> typename Sapphire::PODVector<T>::ConstIterator begin(const Sapphire::PODVector<T>& v) { return v.Begin(); }

	template <class T> typename Sapphire::PODVector<T>::ConstIterator end(const Sapphire::PODVector<T>& v) { return v.End(); }

	template <class T> typename Sapphire::PODVector<T>::Iterator begin(Sapphire::PODVector<T>& v) { return v.Begin(); }

	template <class T> typename Sapphire::PODVector<T>::Iterator end(Sapphire::PODVector<T>& v) { return v.End(); }
