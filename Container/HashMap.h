...
namespace Sapphire
{
	...
	public:
		...
		void Sort()
		{
			...
			Sapphire::Sort(RandomAccessIterator<Node*>(ptrs), RandomAccessIterator<Node*>(ptrs + numKeys), CompareNodes);
...
namespace std
{
	...
	template <class T, class U> typename Sapphire::HashMap<T, U>::ConstIterator begin(const Sapphire::HashMap<T, U>& v)
	{
		return v.Begin();
	}

	template <class T, class U> typename Sapphire::HashMap<T, U>::ConstIterator end(const Sapphire::HashMap<T, U>& v) { return v.End(); }

	template <class T, class U> typename Sapphire::HashMap<T, U>::Iterator begin(Sapphire::HashMap<T, U>& v) { return v.Begin(); }

	template <class T, class U> typename Sapphire::HashMap<T, U>::Iterator end(Sapphire::HashMap<T, U>& v) { return v.End(); }
